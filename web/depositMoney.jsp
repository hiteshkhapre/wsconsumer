...
<div class="wpmd">
<UL>
    <li><a href="index.jsp" ><font  face="Tahoma" class="ws8"><B>LOG OUT</B></font></a></li>
</UL>
...
<div style="position:absolute; overflow:hidden; left:350px; top:180px; width:500px; height:auto; z-index:1">
    <p style="text-align: center;"><b>Deposit Money</b></p>
...
<p style="text-align: center;">Amount to be deposited :<input maxlength="50" name="depositAmount" size="30" type ="text" value=""></p>

<p style="text-align: center;"><input name="submit" type="submit" value="Deposit" /></p>
</form>     
        </div>
